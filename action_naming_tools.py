    ...
    def execute(self, context):
        ...
        try:
            ...
            if translated_text:
                ...
                cleaned_text = translated_text.lower().replace(" ", "_")
                # 移除非字母数字和下划线的字符，包括"_"等符号
                import re
                cleaned_text = re.sub(r'[^a-zA-Z0-9]', '', cleaned_text)
                
                # 添加01后缀
                base_name = cleaned_text + "01"
...
class POPTOOLS_OT_action_naming_popup(Operator):
    ...
    def draw(self, context):
        ...
        if context.active_object:
            ...
            info_box.operator("wm.url_open", text="点击打开蜂鸟动作资产表", icon='URL').url = "https://inspire.sg.larksuite.com/docx/SWvoduj8SoIpxqxuBd9uplEtssg?from=from_copylink"
